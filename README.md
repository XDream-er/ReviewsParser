...
- Использование Gzip-сжатия для уменьшения объема передаваемых данных внутри системы.

![Панель управления](images/1.png)

![Агент0](images/2.2.png)

![Агент1](images/2.png)

![Swagger](images/3.png)

![Экспортированные данные](images/4.png)
---
...
*   Парсинг реализован на уровне DOM-модели (с помощью `HtmlAgilityPack`) а так же регулярных выражений. Планируется добавить `Selenium`.
